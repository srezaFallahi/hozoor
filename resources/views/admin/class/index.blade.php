                    ...
                    <div class="col-12">
                        <div class="row text-right">
                            ...
                            <div class="col-3">
                                ...
                                <input type="checkbox" value="5" name="daysArray[]" id="6">
                            </div>
                            <div class="col-3">

                                <lable style="font-family: Sahel;font-weight: bold;color: black" for="7"> جمعه</lable>
                                <input type="checkbox" value="6" name="daysArray[]" id="7">
                            </div>
                        </div>
                    </div>
