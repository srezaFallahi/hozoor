                ...
                @permission('teacher-controller')
                    ...
                    @permission('teacher-controller')
                        <li class="nav-item">
                            ...
                            <div id="collapseUtilities" class="collapse" aria-expanded="false"
                                ...
                                <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <a class="collapse-item text-right" href="{{ route('student.create') }}">اضافه کردن<i
                                            class="fas fa-user-plus"></i> </a>
                                    <a class="collapse-item text-right"
                                        href="{{ route('student.show', Auth::user()->userable->userable_id) }}">نمایش دانش
                                        آموزان <i class="fas fa-users"></i>
                                    </a>
                                </div>
                            </div>
                        </li>
                        ...
                        @permission('teacher-controller')
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-right"
                                    href="{{ route('grade.show', Auth::user()->userable->userable_id) }}">
                                ...
                                @permission('Manager-controller')
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-right" href="{{ route('manager.index') }}">
                                            <span style="font-family: Sahel;font-weight: bold;"> مدیران </span>
                                            <i class="fas fa-chalkboard"></i></a>
                                    </li>
                                    @endpermission
                                    <!-- Divider -->
