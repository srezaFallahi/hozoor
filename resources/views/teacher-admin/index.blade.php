            ...
            <table class="table  text-center">
                ...
                @foreach($students as $student)
                    <tr>
                        ...
                        <td style="font-family: Sahel;font-weight: normal">{{$student->first_name}}</td>
                        <td style="font-family: Sahel;font-weight: normal">{{$student->last_name}}</td>
                        <td style="font-family: Sahel;font-weight: normal">{{$student->dad_name}}</td>
                        <td style="font-family: Sahel;font-weight: normal">{{$student->personal_code}}</td>
                        ...
                        <td style="font-family: Sahel;font-weight: normal"><a
                                href="{{route('teacher.edit',$student->id)}}"
